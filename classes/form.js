...
function importusers_showHide(img, hidetext, showtext){
...
function importusers_setExpanded(ids, expanded) {
    ...
    for (var i=0; i<i_max; i++) {
        ...
        if (obj) {
            ...
            if (legend) {
                ...
                img.onclick = importusers_showHide;
...
importusers_setExpanded(['names', 'defaults', 'display'], false);
//]]>