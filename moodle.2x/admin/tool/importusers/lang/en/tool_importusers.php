...
$string['emptyimportfile'] = 'The import file appears to be empty.';
...
$string['forcepasswordchange_help'] = 'Do you wish to force imported users to change their password?';
$string['forcepasswordchange'] = 'Force password change';
$string['pageheaderimport'] = 'Import users: Import data';
$string['pageheaderpreview'] = 'Import users: Preview data';
$string['pageheaderupload'] = 'Import users: Upload data';
...
$string['previewdata'] = 'Preview data in the import file';
